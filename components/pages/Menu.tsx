...
const Menu = () => {
  return (
    <section className='bg-[#373535] text-white p-5'>
        ...
        <div className='flex flex-wrap justify-between items-center gap-10'>
            <div className='flex flex-col justify-center items-center gap-2 cursor-pointer'>
                ...
                <div className='text-center'>
                    ...
                    <p className='text-sm w-full max-w-96'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Maxime atque et tempora nam iste ex nesciunt porro doloribus quaerat placeat?</p>
                </div>
            </div>
            <div className='flex flex-col justify-center items-center gap-2 cursor-pointer'>
                <Image
